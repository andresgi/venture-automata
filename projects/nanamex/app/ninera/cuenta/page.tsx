...
export default async function NineraAccountPage() {
  ...
  return <><NineraNavigation /><main className="mx-auto min-h-screen w-full max-w-[1120px] bg-bg px-4 py-8 pb-24 text-ink-900 sm:px-6 lg:ml-[248px] lg:w-[calc(100%-248px)] lg:px-10 lg:py-12"><h1 className="text-h1">Cuenta</h1><NineraPlaceholder title="Cuenta de niñera" description="La configuración de tu cuenta estará disponible próximamente." /></main></>;
}
